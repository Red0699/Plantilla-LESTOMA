...
import CustomButton from '../../../layouts/button/CustomButton';
    ...
    return (
        <>
            ...
            <div className="d-sm-flex align-items-center justify-content-between mb-4">
                ...
                <a href="#" className="d-none d-sm-inline-block btn btn-sm btn-outline-orange shadow-sm"><i className="fas fa-download fa-sm text-white-50"></i> Generate Report</a>
