                ...
                <div class="col-lg-6">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <a href="#" class="btn btn-aqua btn-circle">
                                <i class="fas fa-trash"></i>
                            </a>
                            <a href="#" class="btn btn-orange btn-circle">
                                <i class="fas fa-trash"></i>
                            </a>
                            ...
                            <a href="#" class="btn btn-aqua btn-circle btn-sm">
                                <i class="fas fa-trash"></i>
                            </a>
                            <a href="#" class="btn btn-orange btn-circle btn-sm">
                                <i class="fas fa-trash"></i>
                            </a>
                            ...
                            <a href="#" class="btn btn-aqua btn-circle btn-lg">
                                <i class="fas fa-trash"></i>
                            </a>
                            <a href="#" class="btn btn-orange btn-circle btn-lg">
                                <i class="fas fa-trash"></i>
                            </a>
                        </div>
                    </div>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="my-2"></div>
                            <a href="#" class="btn btn-aqua btn-icon-split">
                                <span class="icon text-gray-600">
                                    <i class="fas fa-laptop"></i>
                                </span>
                                <span class="text">Split Button Aqua</span>
                            </a>
                            <div class="my-2"></div>
                            <a href="#" class="btn btn-orange btn-icon-split">
                                <span class="icon text-gray-600">
                                    <i class="fas fa-laptop"></i>
                                </span>
                                <span class="text">Split Button Orange</span>
                            </a>
