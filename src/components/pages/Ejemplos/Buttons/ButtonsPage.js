                ...
                <div className="col-lg-6">
                    ...
                    <div className="card shadow mb-4">
                        ...
                        <div className="card-body">
                            ...
                            <a href="#" className="btn btn-aqua btn-circle">
                                <i className="fas fa-trash"></i>
                            </a>
                            <a href="#" className="btn btn-orange btn-circle">
                                <i className="fas fa-trash"></i>
                            </a>
                            ...
                            <a href="#" className="btn btn-aqua btn-circle btn-sm">
                                <i className="fas fa-trash"></i>
                            </a>
                            <a href="#" className="btn btn-orange btn-circle btn-sm">
                                <i className="fas fa-trash"></i>
                            </a>
                            ...
                            <a href="#" className="btn btn-aqua btn-circle btn-lg">
                                <i className="fas fa-trash"></i>
                            </a>
                            <a href="#" className="btn btn-orange btn-circle btn-lg">
                                <i className="fas fa-trash"></i>
                            </a>
                        </div>
                    </div>
                    ...
                    <div className="card shadow mb-4">
                        ...
                        <div className="card-body">
                            ...
                            <a href="#" className="btn btn-google btn-block"><i className="fab fa-google fa-fw"></i> .btn-google</a>
                            <a href="#" className="btn btn-facebook btn-block"><i className="fab fa-facebook-f fa-fw"></i> .btn-facebook</a>
                ...
                <div className="col-lg-6">
                    ...
                    <div className="card shadow mb-4">
                        ...
                        <div className="card-body">
                            ...
                            <div className="my-2"></div>
                            <a href="#" className="btn btn-aqua btn-icon-split">
                                <span className="icon text-gray-600">
                                    <i className="fas fa-laptop"></i>
                                </span>
                                <span className="text">Split Button Aqua</span>
                            </a>
                            <div className="my-2"></div>
                            <a href="#" className="btn btn-orange btn-icon-split">
                                <span className="icon text-gray-600">
                                    <i className="fas fa-laptop"></i>
                                </span>
                                <span className="text">Split Button Orange</span>
                            </a>
